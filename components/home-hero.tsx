...
export function HomeHero({
  ...
  return (
    <section className="relative h-[40vh] min-h-[280px] w-screen overflow-hidden -mt-6 left-1/2 -translate-x-1/2">
      ...
      <div className="absolute bottom-20 left-5 z-10 cursor-pointer" onClick={openFullSummary}>
        ...
        {settings.dashboard.showBalance && (
          <>
            ...
            <p className="text-5xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-white">
