...
export const categories: CategoryMeta[] = [
  ...
  },
  {
    ...
    color: 'oklch(0.68 0.18 295)',
    keywords: [
      'calceta', 'camisa', 'pantalón', 'pantalon', 'tenis', 'zapato',
      'chamarra', 'uniforme', 'playera', 'vestido', 'short', 'blusa',
      'falda', 'cinturón', 'cinturon', 'corbata', 'bufanda', 'guante',
      'gorra',
    ],
  },
  {
    ...
    keywords: [
      'laptop', 'computadora', 'celular', 'iphone', 'cargador',
      'audífono', 'audifono', 'mouse', 'teclado', 'monitor',
      'software', 'app', 'disco duro', 'memoria', 'cable',
      'hub', 'adaptador', 'router',
    ],
  },
  {
    label: 'Casa',
    ...
    color: 'oklch(0.78 0.16 120)',
    keywords: [
      'renta', 'luz', 'cfe', 'agua', 'internet', 'limpieza',
      'mueble', 'cortina', 'alfombra', 'colchón', 'colchon',
      'lámpara', 'lampara', 'persiana', 'reparación', 'reparacion',
      'cerrajero', 'plomero', 'electricista',
    ],
  },
  {
    label: 'Deudas',
    ...
    color: 'oklch(0.68 0.19 25)',
    keywords: [
      'pago tarjeta', 'abono', 'préstamo', 'prestamo', 'crédito',
      'credito', 'deuda', 'bancomer', 'bbva', 'nu',
      'pago mínimo', 'pago minimo', 'atraso', 'interés', 'interes',
      'comisión', 'comision',
    ],
  },
  {
...
/** Reverse map: account type → payment method. */
export const accountTypeToMethod: Record<string, Method> = {
  efectivo: 'Efectivo',
  debito: 'Débito',
  credito: 'Crédito',
  ahorro: 'Ahorro',
